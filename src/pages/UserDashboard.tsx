    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-lg mx-auto space-y-6">
          ...
          <div className="bg-card border border-border/50 rounded-xl p-6 shadow-sm space-y-8 text-left">
            <div>
              ...
              <div className="mt-4 p-3 bg-muted/30 rounded-lg text-sm font-medium">
